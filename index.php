...
// get LTStatus
$ch = curl_init($lt_url.'LTStatus');

//$ch = curl_init("http://lab.responsive.net/Littlefield/LTStatus");
...
// get Standing
$ch = curl_init($lt_url.'Standing');

//$ch = curl_init("http://lab.responsive.net/Littlefield/Standing");
...
<title>Tbsoperaman: Littlefield Monitor</title>
...
<h1>Littlefield Monitor</h1>
<h3>You are here: <a href = "#">HOME</a>
<br>
Our Current Balance: <b><?php echo $bal;  ?></b>
<br>
Current Day: <b><?php echo $date; ?> </b>
</h3>
...
<thead class="fixedHeader">
	<tr>
		<th>Directory</th>
		<th>Click below link</th>
	</tr>
</thead>
<tbody class="scrollContent">
	<tr>

		<td>Up to date data</td>
		<td><a href="/MBA_LittleField/littlefield2-uptodate.php">Update Now</a></td>
	</tr>
	<!--
	<tr>
		<td>Download Raw data</td>
		<td><a href="/MBA_LittleField/summary.php">CSV</a></td>
	</tr>
	<tr>
		<td>Summary data</td>
		<td><a href="/MBA_LittleField/littlefield2-summary.php">Summary</a></td>
	</tr>
-->
	<tr>
		<td></td>
...
while ($pos1 > 0)
{
	...
	if($team == 'ninetrogen'){
			echo "<tr>";
	echo "<td bgcolor = '#d0e4fe'><b>".$rank."</b></td>";
	echo "<td bgcolor = '#d0e4fe'><b>"."==== We are here!===="."</b></td>";
	echo "<td bgcolor = '#d0e4fe'><b>".$bal."</b></td>";
	echo "</tr>";
	}else{
	echo "<tr>";
	echo "<td>".$rank."</td>";
...
// OrdersMenu
$ch = curl_init($lt_url.'OrdersMenu');

//$ch = curl_init("http://lab.responsive.net/Littlefield/OrdersMenu");

curl_setopt($ch, CURLOPT_HEADER, 0);
curl_setopt($ch, CURLOPT_COOKIEFILE, COOKIE_FILE);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);

$ordersMenu = curl_exec($ch);
curl_close($ch);


$find_font   = '<b>Maximum';
$findme2   = 'dollars<BR><HR>';

$pos1 = strpos($ordersMenu, $find_font);
$ordersMenu = substr($ordersMenu, $pos1);

$pos2 = strpos($ordersMenu, $findme2);
$ordersMenu = substr($ordersMenu, 0, $pos2);


// MaterialMenu
$ch = curl_init($lt_url.'MaterialMenu');
...
$materialMenu = curl_exec($ch);
curl_close($ch);

$find_font   = '<BR><B>Unit Cost:';
$findme2   = '<BR><HR><I>P';

$pos1 = strpos($materialMenu, $find_font);
$materialMenu = substr($materialMenu, $pos1);

$pos2 = strpos($materialMenu, $findme2);
$materialMenu = substr($materialMenu, 0, $pos2);
...
<tbody class='scrollContent'>";
echo "	<tr>";
echo "<td>".$ordersMenu. 'dollars'."<HR></td>";
echo "<td>".$materialMenu."<HR></td>";
echo "</tr>";
echo "</table>";
?>
...
sleep($sleep_time);
// Station Menu 1
$ch = curl_init($lt_url.'StationMenu?id=1');

//$ch = curl_init("http://lab.responsive.net/Littlefield/StationMenu?id=1");
...
$find_font   = '<P><B> Number';
$findme2   = '<I>Please';

$pos1 = strpos($s1Menu, $find_font);
$s1Menu = substr($s1Menu, $pos1);

$pos2 = strpos($s1Menu, $findme2);
$s1Menu = substr($s1Menu, 0, $pos2);
...
// Station Menu 2
$ch = curl_init($lt_url.'StationMenu?id=2');
...
$pos1 = strpos($s2Menu, $find_font);
$s2Menu = substr($s2Menu, $pos1);

$pos2 = strpos($s2Menu, $findme2);
$s2Menu = substr($s2Menu, 0, $pos2);

sleep($sleep_time);

// Station Menu 3
$ch = curl_init($lt_url.'StationMenu?id=3');
...
$pos1 = strpos($s3Menu, $find_font);
$s3Menu = substr($s3Menu, $pos1);

$pos2 = strpos($s3Menu, $findme2);
$s3Menu = substr($s3Menu, 0, $pos2);

echo "<table border='0' cellpadding='0' cellspacing='0' width='100%' class='scrollTable'>
<thead class='fixedHeader'>
	<tr>
		<th>Station Menu 1</th>
		<th>Station Menu 2</th>
		<th>Station Menu 3</th>
	</tr>
</thead>
<tbody class='scrollContent'>";
echo "	<tr>";
